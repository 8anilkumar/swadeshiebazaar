...
public class SellAllProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  view= inflater.inflate(R.layout.fragment_sell_all_product, container, false);
        ...
        viewAllFList= (List<home_data_model.LayoutDatum>) getArguments().getSerializable("list");
    ...
    private void getProductList(){
        ...
        SellProductAdapter offersAdapter = new SellProductAdapter(viewAllFList, getContext(),SellAllProductFragment.this);
